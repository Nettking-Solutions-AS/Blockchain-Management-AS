...
function sign(signerAddress, tx, signer, _a, prefix // should ideally come from signer, but not exposed by cosmjs at this time
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    myAminoTypes = new stargate_1.AminoTypes(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign({}, (0, stargate_1.createAuthzAminoConverters)()), (0, stargate_1.createBankAminoConverters)()), (0, stargate_1.createDistributionAminoConverters)()), (0, stargate_1.createFreegrantAminoConverters)()), (0, stargate_1.createGovAminoConverters)()), (0, stargate_1.createIbcAminoConverters)()), (0, stargate_1.createStakingAminoConverters)(prefix)), (0, modules_1.createVestingAminoConverters)()), amino_1.thorchain.createAminoConverters()));
...
function parse_legacy_tx_format(_a) {
    var fee = _a.fee, memo = _a.memo, msg = _a.msg, signatures = _a.signatures;
    if (msg.length !== 1)
        throw new Error('multiple msgs not supported!');
    return __assign(__assign({}, convertLegacyMsg(msg[0])), { fee: {
            amount: scrubCoins(fee.amount),
            gas: fee.gas
        }, memo: memo, signatures: signatures });
}
