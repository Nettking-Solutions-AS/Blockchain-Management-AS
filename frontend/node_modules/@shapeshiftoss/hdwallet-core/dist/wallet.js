...
function supportsBTC(wallet) {
    return isObject_1.default(wallet) && wallet._supportsBTC;
}
exports.supportsBTC = supportsBTC;
function infoBTC(info) {
    return isObject_1.default(info) && info._supportsBTCInfo;
}
exports.infoBTC = infoBTC;
function supportsETH(wallet) {
    return isObject_1.default(wallet) && wallet._supportsETH;
}
exports.supportsETH = supportsETH;
function infoETH(info) {
    return isObject_1.default(info) && info._supportsETHInfo;
}
exports.infoETH = infoETH;
function supportsCosmos(wallet) {
    return isObject_1.default(wallet) && wallet._supportsCosmos;
}
exports.supportsCosmos = supportsCosmos;
function supportsEthSwitchChain(wallet) {
    return isObject_1.default(wallet) && wallet._supportsEthSwitchChain;
}
